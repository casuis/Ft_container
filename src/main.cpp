...
/*   Updated: 2022/10/28 16:39:34 by asimon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			}
// 			tab.swap(tab2);
// 			NAMESPACE::vector<int>::iterator	it1 = tab2.begin();
// 			NAMESPACE::vector<int>::iterator	ite1 = tab2.end();
// 			std::cout << std::endl;
// 			for (; it1 != ite1; it1++){
...
// 					std::cout << "1er call: " << tab.at(i).at(j) << std::endl;
// 				}
// 			}
// 			std::cout << std::endl;
...
// 			for (size_t i = 0; i < tab.size(); i++){
// 				for (size_t j = 0; j < tab.at(i).size(); j++){
// 					std::cout << "2eme call: " << tab.at(i).at(j) << std::endl;
// 				}
// 			}
